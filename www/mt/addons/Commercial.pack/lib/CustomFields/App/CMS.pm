...
sub load_customfield_types {
    my $customfield_types = {
        ...
        'text' => {
            ...
            field_html => q{
                <input type="text" name="<mt:var name="field_name" escape="html">" id="<mt:var name="field_id">" class="form-control text" value="<mt:var name="field_value" escape="html">" />
            },
        ...
        'textarea' => {
            ...
            field_html => {
                default => q{
                    <textarea name="<mt:var name="field_name" escape="html">" id="<mt:var name="field_id">" class="form-control text high"><mt:var name="field_value" escape="html"></textarea>
                },
        ...
        'checkbox' => {
            ...
            field_html => q{
                ...
                <div class="custom-control custom-checkbox hint">
                  <input type="checkbox" name="<mt:var name="field_name" escape="html">" value="1" id="<mt:var name="field_id">"<mt:if name="field_value"> checked="checked"</mt:if> class="custom-control-input cb" />
                  <label class="custom-control-label" for="<mt:var name="field_id" escape="html">"><mt:var name="description" escape="html"></label>
                </div>
            },
        ...
        'datetime' => {
            ...
            options_field => q{
                <div class="form-inline">
                    <__trans phrase="Show">: <select name="options" id="options" class="custom-select form-control">
        ...
        'select' => {
            ...
            field_html => q{
                    <select name="<mt:var name="field_name" escape="html">" id="<mt:var name="field_id">" class="custom-select form-control se" mt:watch-change="1">
            ...
            options_field => q{
                ...
                <p class="text-muted hint"><__trans phrase="Please enter all allowable options for this field as a comma delimited list"></p>
            },
            options_delimiter => ',',
            column_def        => 'vchar_idx',
            order             => 600,
    ...
    foreach my $type (qw(entry page)) {
        ...
        <div class="form-check form-check-inline">
          <div class="custom-control custom-checkbox">
            <input type="checkbox" name="${type}_custom_prefs" id="custom-prefs-customfield_<mt:var name="basename">" value="customfield_<mt:var name="basename">" <mt:if name="show_field"> checked="checked"</mt:if><mt:if name="lock_field"> disabled="disabled"</mt:if> class="custom-control-input cb" />
            <label class="custom-control-label" for="custom-prefs-customfield_<mt:var name="basename" escape="html">"><mt:var name="name" escape="html"></label>
          </div>
        </div>
        </mt:loop>
HTML
        ...
        my $text     = <<EOT;
                <li>
                    ...
                    <__trans_section component="commercial">
                        <input type="checkbox" name="clone_prefs_customfields" id="clone-prefs-customfields" <mt:if name="clone_prefs_customfields">checked="<mt:var name="clone_prefs_customfields">"</mt:if> class="custom-control-input cb" />
                        <label class="custom-control-label" for="clone-prefs-customfields"><__trans phrase="Custom Fields"></label>
                    </__trans_section>
                    </div>
                </li>
EOT
